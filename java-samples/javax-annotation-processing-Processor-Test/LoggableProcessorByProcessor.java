 ...
 * @SupportedAnnotationTypes("org.d13.annotation.Loggable")由于没有这个注解，所以在执行命令
 * javac -processor LoggableProcessorByProcessor CustomAnnotationServiceImpl.java 
 * 时，命令行中没有任何输出，推测：是因为找不到这个注解类，改成“@SupportedAnnotationTypes("Loggable")”，
 * 再执行上述命令正常输出。
 */
@SupportedAnnotationTypes("Loggable") // 指定处理的注解
