...
public class OrderController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger( org.d13.examples.OrderController.class);
	...
	public String order(String userId, String commodityCode, int orderCount) {
		...
		final org.d13.examples.Order order = new org.d13.examples.Order ();
		order.userId = userId;
