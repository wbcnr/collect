...
@SupportedAnnotationTypes("org.d13.annotation.BuildProperty2") // Only process the annotation with the type of BuildProperty;
public class SzzBuilderProcessor2 extends AbstractProcessor {
    @Override
    public boolean process( Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        System.out.println("SzzBuildProcessor2.process ;");
        System.out.println ("这个自定义注解处理器是使用@AutoService(Processor.class)注解的.");
        for (TypeElement annotation : annotations) {
            //输出annotation的全量限定名
            System.out.println ("SzzBuilderProcessor2.process-> annotation : " + annotation.getSimpleName ());
